...
Овај пројекат је отворен за личну и академску употребу.

## Аутор

Развијено као вежба за Android развој.

## Контрибуција

Приложи су добродошли! За веће одлике отвори GitHub issue или пришаљи pull request.
